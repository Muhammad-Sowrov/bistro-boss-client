      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-200">
        <div className="bg-white p-8 rounded-lg shadow-lg w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
          ...
          <form onSubmit={handleLogin}>
            ...
            <input disabled={disabled} type="submit" className='w-full btn btn-primary text-black font-semibold p-2 rounded focus:outline-none focus:bg-green-600' value="Login" />
          </form>
